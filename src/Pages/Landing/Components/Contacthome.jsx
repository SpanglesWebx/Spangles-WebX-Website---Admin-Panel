  ...
  return (
    <section className="w-full bg-[#F4F7FA] px-[75px]  relative z-30 -mb-[100px] max-[1025px]: -mt-[55px] max-[413px]:px-4 max-[413px]:mb-0">
      ...
      <div className="mb-10 translate-y-[100px] max-[413px]:translate-y-0 max-[413px]:mb-6">
        <p className="font-montserrat font-bold text-[14px] leading-[100%]  tracking-[1.43px] uppercase text-[#395563] mb-2 max-[413px]:text-[10px] max-[413px]:pt-10">
          CONTACT US
        </p>
          ...
          <form className="relative z-10" onSubmit={handleSubmit} noValidate>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-7.5 mb-11 max-[413px]:mb-6 max-[413px]:gap-y-[25px]">
              <div>
                <input
                  ...
                  className={`w-full h-[48px] font-montserrat font-normal text-[14px] leading-[100%] tracking-[0px] text-[#345261] align-middle px-[15px] py-[20px] border rounded-[10px] outline-none focus:border-[#345261] placeholder:text-[#677289] max-[413px]:bg-white  ${
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-7.5 mb-11 max-[413px]:mb-6 max-[413px]:gap-y-[25px]">
              ...
              <div>
                <input
                  ...
                  className="w-full h-[48px] font-montserrat font-normal text-[14px] leading-[100%] text-[#345261] px-[15px] border border-gray-300 rounded-[10px] outline-none focus:border-[#345261] placeholder:text-[#677289] max-[413px]:bg-white"
                />
              </div>
            </div>
            ...
            <div className="mb-[35px]">
              <textarea
                ...
                className={`w-full font-montserrat font-normal text-[14px] leading-[100%] text-[#345261] px-[15px] py-[20px] border rounded-[10px] outline-none resize-none focus:border-[#345261] placeholder:text-[#677289] max-[413px]:bg-white ${
