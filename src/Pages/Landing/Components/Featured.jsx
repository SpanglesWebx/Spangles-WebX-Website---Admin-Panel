      ...
      <div className="relative z-[1] overflow-visible">
        ...
        <div className="absolute top-0 left-0 right-0 h-[calc(100%-300px)] max-[1201px]:h-[calc(100%-350px)] max-[1025px]:h-[calc(100%-400px)] max-[413px]:h-[calc(100%-550px)] pointer-events-none">
          <div className="sticky top-0 z-[5] bg-transparent text-center pt-[80px] max-[1201px]:pt-[75px] max-[1025px]:pt-[70px] max-[413px]:pt-[70px] px-[20px] pb-[40px] max-[1201px]:pb-[30px] max-[1025px]:pb-[25px] max-[413px]:pb-[20px] pointer-events-auto">
            ...
            <div className="absolute -top-[450px] -left-[700px] max-[1201px]:-top-[350px] max-[1201px]:-left-[600px] max-[1201px]:w-[800px] max-[1201px]:h-[900px] max-[1201px]:border-[110px] max-[1025px]:-top-[300px] max-[1025px]:-left-[480px] max-[1025px]:w-[700px] max-[1025px]:h-[700px] max-[1025px]:border-[90px] max-[413px]:-top-[250px] max-[413px]:-left-[350px] w-[900px] h-[1000px] max-[413px]:w-[500px] max-[413px]:h-[500px] rounded-full border-[140px] max-[413px]:border-[60px] border-[rgba(0,0,0,0.08)] pointer-events-none z-0">
              ...
              <div className="mx-[90px] max-[1201px]:mx-[60px] max-[1025px]:mx-[40px] max-[413px]:mx-[24px] flex justify-between items-center max-[413px]:flex-col max-[413px]:items-start gap-[40px] max-[1201px]:gap-[30px] max-[1025px]:gap-[25px] max-[413px]:gap-[25px] bg-[#4c6571] rounded-[16px] p-[45px] max-[1201px]:p-[35px] max-[1025px]:p-[30px] max-[413px]:p-[24px] border border-[rgba(255,255,255,0.1)] min-h-[280px] max-[1201px]:min-h-[260px] max-[1025px]:min-h-[240px] max-[413px]:min-h-0">
                ...
                <div className="flex-1 max-[413px]:w-full max-[413px]:flex-none">
                  ...
                  <div className="flex gap-[20px] max-[1201px]:gap-[15px] max-[1025px]:gap-[10px] max-[413px]:flex-col max-[413px]:gap-[8px] text-white font-montserrat font-semibold text-[16px] max-[1201px]:text-[16px] max-[1025px]:text-[14px] max-[413px]:text-[14px] max-[413px]:leading-[20px] leading-[27.32px] tracking-[0px]">
                    <span className="flex items-center gap-[8px]"><span className="text-[#A7A7A7] max-[1201px]:text-[16px] max-[1025px]:text-[14px] max-[413px]:text-[14px]">✔</span> 900% increase in ROI</span>
                    <span className="flex items-center gap-[8px]"><span className="text-[#A7A7A7] max-[1201px]:text-[16px] max-[1025px]:text-[14px] max-[413px]:text-[14px]">✔</span> 40% decrease in CAC</span>
                  </div>

                  <button className="font-montserrat font-bold text-[15px] max-[1201px]:text-[15px] max-[1025px]:text-[14px] max-[413px]:text-[13px] max-[1201px]:py-[14px] max-[1201px]:px-[18px] max-[1025px]:py-[12px] max-[1025px]:px-[16px] max-[413px]:py-[12px] max-[413px]:px-[18px] leading-[24.29px] tracking-[0px] mt-[20px] max-[413px]:mt-[20px] bg-[#395563] text-white py-[13px] px-[17px] rounded-[10px] border-none">
