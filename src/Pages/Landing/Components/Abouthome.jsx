...
export default function AboutSection() {
  ...
  return (
    <section className="bg-[#ffffff]">
      <div className="w-full mx-auto min-[1600px]:max-w-[1440px] min-[1920px]:max-w-[1600px] px-[100px] py-[100px] grid md:grid-cols-2 gap-16 items-center md:max-[1025px]:items-start max-[1025px]:gap-12 max-[1025px]:px-[60px] max-[1025px]:py-[70px] max-[413px]:px-4 max-[413px]:py-[60px] max-[413px]:gap-10">
        {/* LEFT IMAGE */}
        ...
        <div>
          ...
          <p className="w-full max-w-lg min-[1600px]:max-w-xl min-[1920px]:max-w-2xl font-montserrat font-normal text-[#6B6A66] text-[16px] leading-[23.65px] mb-10 max-[413px]:text-[14px] max-[413px]:leading-[20px] max-[413px]:mb-8">
